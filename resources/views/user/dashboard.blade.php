                                ...
                                <div class="mt-2 mb-4">
                                    ...
                                    <div class="d-flex align-items-center smaller">
                                        <div class="change up"><em
                                                class="icon ni ni-upword-alt-fill"></em> 10.5%</div>
                                        <span class="text-light">From last 2 Weeks</span>
                                    </div>
                                </div>
                                <div class="nk-chart-analytics-session"><canvas data-nk-chart="bar"
                                        id="sessionChart"></canvas></div>
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <div class="mt-2 mb-4">
                                    ...
                                    <div class="d-flex align-items-center smaller">
                                        <div class="change up"><em
                                                class="icon ni ni-upword-alt-fill"></em> 12%</div><span
                                            class="text-light">From last month</span>
                                    </div>
                                </div>
                                <div class="nk-chart-analytics-session"><canvas data-nk-chart="line"
                                        id="sessionChartAvg"></canvas></div>
                                <div class="chart-label-group justify-content-between mt-1">
                                    <div class="chart-label chart-label-small">
                                        <div class="title">1 May</div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="card-title-group align-items-start">
                                    ...
                                    <div
                                        ...
                                        <em class="icon icon-md ni ni-activity-round-fill"></em></div>
                                </div>
                                <div class="mt-2 mb-4">
                                    <div class="amount h1">1,853</div>
                                    <div class="d-flex align-items-center smaller">
                                        <div class="change up"><em
                                                class="icon ni ni-upword-alt-fill"></em> 10%</div><span
                                            class="text-light">From last week</span>
                                    </div>
                                </div>
                                <div class="nk-chart-analytics-session"><canvas data-nk-chart="line"
                                        id="bounceRateChart"></canvas></div>
                                <div class="chart-label-group justify-content-between mt-1">
                                    <div class="chart-label chart-label-small">
                                        <div class="title">1 May</div>
                                    </div>
                                ...
                                <div class="mt-2 mb-4">
                                    ...
                                    <div class="d-flex align-items-center smaller">
                                        <div class="change down"><em
                                                class="icon ni ni-downward-alt-fill"></em> 12%</div>
                                        <span class="text-light">From last month</span>
                                    </div>
                                </div>
                                <div class="nk-chart-analytics-session"><canvas data-nk-chart="bar"
                                        id="goalCompletions"></canvas></div>
                                <div class="chart-label-group justify-content-between mt-1">
                                    <div class="chart-label chart-label-small">
                                        <div class="title">1 May</div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="card-title-group flex-wrap">
                                    ...
                                    <div class="chart-legend-group gap gx-3 align-items-center">
                                        <div class="gap-col">
                                            <div class="chart-legend chart-legend-small"><span
                                ...
                                <div class="nk-chart-analytics-audience-overview mt-3"><canvas
                                        data-nk-chart="line" id="audienceOverviewChart"></canvas></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6">
                                    ...
                                    <thead class="table-light table-head-sm">
                                        <tr>
                                            <th class="tb-col"><span
                                                    class="overline-title">source</span></th>
                                            <th class="tb-col tb-col-end"><span
                                                    class="overline-title">visitors</span></th>
                                            <th class="tb-col tb-col-end"><span
                                                    class="overline-title">revenues</span></th>
                                            <th class="tb-col tb-col-end"><span
                                                    class="overline-title">sales</span></th>
                                            <th class="tb-col tb-col-end"><span
                                            ...
                                            <td class="tb-col">
                                                <div class="media-group">
                                                    <div
                                                        ...
                                                        <em class="icon ni ni-github-circle"></em></div>
                                                    <div class="media-text"><span
                                                            class="title">github.com</span></div>
                                                </div>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="small">2.4K</span></td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="change up small">$3.877</span></td>
                                            <td class="tb-col tb-col-end"><span class="small">267</span>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="text-info small">4.7%</span></td>
                                        </tr>
                                        <tr>
                                            <td class="tb-col">
                                                <div class="media-group">
                                                    <div
                                                        ...
                                                        <em class="icon ni ni-twitter"></em></div>
                                                    <div class="media-text"><span
                                                            class="title">twitter.com</span></div>
                                                </div>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="small">2.2K</span></td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="change up small">$3.444</span></td>
                                            <td class="tb-col tb-col-end"><span class="small">265</span>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="text-info small">4.5%</span></td>
                                        </tr>
                                        <tr>
                                            <td class="tb-col">
                                                <div class="media-group">
                                                    <div
                                                        ...
                                                        <em class="icon ni ni-google"></em></div>
                                                    <div class="media-text"><span
                                                            class="title">google.com</span></div>
                                                </div>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="small">2.1K</span></td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="change up small">$3.232</span></td>
                                            <td class="tb-col tb-col-end"><span class="small">264</span>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="text-info small">4.3%</span></td>
                                        </tr>
                                        <tr>
                                            <td class="tb-col">
                                                <div class="media-group">
                                                    <div
                                                        ...
                                                        <em class="icon ni ni-vimeo"></em></div>
                                                    <div class="media-text"><span
                                                            class="title">vimeo.com</span></div>
                                                </div>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="small">2.0K</span></td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="change up small">$3.212</span></td>
                                            <td class="tb-col tb-col-end"><span class="small">261</span>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="text-info small">4.1%</span></td>
                                        </tr>
                                        <tr>
                                            <td class="tb-col">
                                                <div class="media-group">
                                                    <div
                                                        ...
                                                        <em class="icon ni ni-digital-ocean"></em></div>
                                                    <div class="media-text"><span
                                                            class="title">digital-ocean.com</span></div>
                                                </div>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="small">1.8K</span></td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="change up small">$3.105</span></td>
                                            <td class="tb-col tb-col-end"><span class="small">260</span>
                                            </td>
                                            <td class="tb-col tb-col-end"><span
                                                    class="text-info small">3.1%</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
