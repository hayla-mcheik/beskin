                ...
                <div class="nk-block-head">
                    <div class="nk-block-head-between flex-wrap gap g-2">
                        <div class="nk-block-head-content">
                            <h2 class="nk-block-title">Portfolio Images</h1>
                                <nav>
                        ...
                        <div class="nk-block-head-content">
                           ...
                           <li>
                            <a href="{{ route('admin.portfolio.create.images' , ['id' => $portfolio->id ]) }}" class="btn btn-primary d-none d-md-inline-flex">
                        ...
                        <table class="datatable-init table" data-nk-container="table-responsive">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="tb-col"><span class="overline-title">Images</span></th>
                          ...
                          @foreach($portfolioimages as $portfolioimage)
                                <tr>                     
                                    ...
                                    <td class="tb-col tb-col-xxl">
                                        <img src="{{ asset($portfolioimage->image) }}" style="width:70px; height:70px;" alt="service image" />
                                    </td>
                                            ...
                                            <div
                                                ...
                                                <div class="dropdown-content py-1">
                                                    <ul
                                                        ...
                                                        <li>
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#deletePortfolioImageModal_{{ $portfolioimage->id }}">
                                ...
                                <div class="modal fade" id="deletePortfolioImageModal_{{ $portfolioimage->id }}" tabindex="-1" aria-labelledby="deletePortfolioImageModal_{{ $portfolioimage->id }}" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('admin.portfolio.delete.images', ['id' => $portfolioimage->id, 'imageid' => $portfolioimage->id]) }}" method="GET">
