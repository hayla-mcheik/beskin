        ...
        <div class="nk-content-inner">
            <div class="nk-content-body">
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">edit Portfolio</h1>
                                    <nav>
                ...
                <div class="nk-block">
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title">Edit Portfolio</h3>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="service_id" class="form-control">
                                                ...
                                                <option value="{{ $service->id }}"  {{ $service->id === $portfolio->service_id ? 'selected':'' }}  >{{ $service->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
