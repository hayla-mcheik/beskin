                ...
                <div class="nk-block-head">
                    <div class="nk-block-head-between flex-wrap gap g-2">
                        ...
                        <div class="nk-block-head-content">
                           ...
                           <li><a href="{{ url('admin/services/create') }}" class="btn btn-primary d-none d-md-inline-flex"><em
                                            class="icon ni ni-plus"></em><span>Add Services</span></a></li> 
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="datatable-init table" data-nk-container="table-responsive">
                          ...
                          @foreach($services as $service)
                                <tr>                     
                                    ...
                                    <td class="tb-col tb-col-xxl">{{  $service->name }}</td>
                                    <td class="tb-col tb-col-xxl">{{  $service->title }}</td>
                                    <td class="tb-col tb-col-xxl">
                                        <img src="{{ asset($service->image) }}" style="width:70px; height:70px;" alt="service image" />
                                    </td>
                                            ...
                                            <div
                                                ...
                                                <div class="dropdown-content py-1">
                                                    <ul
                                                        ...
                                                        <li><a href="{{ route('admin.services.edit' , ['id' => $service->id]) }}"><em
                                                                    class="icon ni ni-edit"></em><span>Edit</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#deleteServiceModal{{ $service->id }}">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('admin.services.delete' , ['id' => $service->id]) }}" method="GET">
                                                    @csrf
                                                    <div class="row g-3">
