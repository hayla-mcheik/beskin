                    ...
                    <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"><span
                        ...
                        <div class="nk-nav-sub">
                            <div class="nk-nav-mega nk-nav-mega-lg">
                                ...
                                <div class="nk-nav-col nk-nav-media"><img src="images/thumb/a.jpg"
            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav ms-2">
                                ...
                                <ul class="dropdown-list gap gy-2">
                                    ...
                                    <li>
                                        <div class="media-group">
                                            <div
                                                class="media media-md media-middle media-circle text-bg-light">
                                                <img src="{{ asset('admin\assets\images\avatar\a.jpg') }}" alt=""></div>
                                            <div class="media-text">
                    ...
                    <li class="dropdown"><a href="#" data-bs-toggle="dropdown">
                            <div class="d-sm-none">
                                <div class="media media-md media-circle"><img src="{{ asset('admin\assets\images\avatar\a.jpg') }}"
                                        alt="" class="img-thumbnail"></div>
                            </div>
                            <div class="d-none d-sm-block">
                                <div class="media media-circle"><img src="{{ asset('admin\assets\images\avatar\a.jpg') }}" alt=""
                        ...
                        <div class="dropdown-menu dropdown-menu-md">
                            <div
                                ...
                                <div class="media-group">
                                    <div class="media media-xl media-middle media-circle"><img
                                        src="{{ asset('admin\assets\images\avatar\a.jpg') }}" alt="" class="img-thumbnail">
                                    </div>
                                    <div class="media-text">
                            ...
                            <div
                                class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                <ul class="link-list">
                                    <li><a href="{{ url('admin/admin/profile') }}"><em class="icon ni ni-user"></em>
                            ...
                            <div class="dropdown-content dropdown-content-x-lg py-3">
                                <ul class="link-list">
                                    <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><em class="icon ni ni-signout"></em> <span>Log
                                                Out</span></a>
